...
function FSTScreen(props) {
  const facDataArray = [];

  for (const data of jsonData) {
    if (data.Major === "Food Science and Technology") {
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <Text style={styles.headerText}>Food Science and Technology</Text>
