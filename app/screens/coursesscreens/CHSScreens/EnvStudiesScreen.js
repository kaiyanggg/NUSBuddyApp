...
function EnvStudiesScreen(props) {
  const facDataArray = [];

  for (const data of jsonData) {
    if (data.Major === "Environmental Studies") {
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <Text style={styles.headerText}>Environmental Studies</Text>
...
export default EnvStudiesScreen;
