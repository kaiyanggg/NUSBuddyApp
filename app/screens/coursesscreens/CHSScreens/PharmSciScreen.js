...
function PharmSciScreen(props) {
  const facDataArray = [];

  for (const data of jsonData) {
    if (data.Major === "Pharmaceutical Science") {
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <Text style={styles.headerText}>Pharmaceutical Science</Text>
