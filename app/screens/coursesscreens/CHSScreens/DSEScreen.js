...
function DSEScreen(props) {
  const facDataArray = [];

  for (const data of jsonData) {
    if (data.Major === "Data Science and Economics") {
      const facData = Object.values(data);
      facDataArray.push(facData);
    }
  }

  console.log({ facDataArray });
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <Text style={styles.headerText}>Data Science and Economics</Text>
