...
function LandscapeArchiScreen(props) {
  const facDataArray = [];

  for (const data of jsonData) {
    if (data.Major === "Landscape Architecture") {
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <Text style={styles.headerText}>Landscape Architecture</Text>
...
export default LandscapeArchiScreen;
